...
import { FaShareAlt, FaFacebookSquare, FaTwitterSquare, FaInstagram } from 'react-icons/fa';
                                    ...
                                    <Col>
                                        <div className="share-icon text-right">
                                            <span className="share-all-icon text-light">
                                                <a href="df" className="px-1"> <FaFacebookSquare/> </a>
                                                <a href="df" className="px-1"> <FaTwitterSquare/> </a>
                                                <a href="df" className="px-1"> <FaInstagram/> </a>
                                            </span>
                                            <span className="text-yellow"> <FaShareAlt/> </span>
                                        </div>
                                    </Col>
                                </Row>
                            </div>
